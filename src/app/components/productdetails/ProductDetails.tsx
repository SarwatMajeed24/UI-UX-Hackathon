    ...
    <div className="font-Satoshi w-[90%] mx-auto mt-8">
      ...
      <div className="flex flex-col lg:flex-row gap-10 justify-between items-start">
        ...
        <div className="w-full lg:w-1/2">
          <h1 className="text-2xl lg:text-3xl font-bold mb-4">ONE LIFE GRAPHIC T-SHIRT</h1>
          ...
          <div className="mb-6">
            ...
            <div className="flex gap-2 flex-wrap">
              {["Small", "Medium", "Large", "X-Large"].map((size) => (
                <button
                  key={size}
                  className="px-4 py-2 border rounded-3xl w-[120px] sm:w-[150px] md:w-[200px] hover:bg-gray-200"
                >
                  {size}
                </button>
              ))}
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <button className="w-[250px] sm:w-[400px] h-[52px] px-6 py-3 bg-black text-white rounded-3xl">
              Add to Cart
            </button>
          </div>
        </div>
